      ...
      <div className="max-w-4xl mx-auto py-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-brand-navy mt-1">Edit Quiz</h1>
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-purple-50 hover:bg-purple-100 text-purple-700 font-bold text-xs flex items-center gap-1.5 transition-all border border-purple-200 cursor-pointer shadow-sm"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold text-xs flex items-center gap-1.5 transition-all border border-indigo-200 cursor-pointer shadow-sm"
            >
        ...
        {saveSuccess && (
          <div className="p-4 mb-6 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-bold flex items-center gap-2 animate-in fade-in">
        ...
        <form onSubmit={handleUpdateQuiz} className="space-y-8">
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-sm font-semibold focus:bg-white focus:outline-none focus:border-brand-purple"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-sm font-medium focus:bg-white focus:outline-none focus:border-brand-purple"
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-black tracking-tight text-brand-navy">Questions ({questions.length})</h2>
            ...
            {questions.map((q, qIndex) => (
              <div
                key={qIndex}
                className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-5 relative"
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5 bg-slate-100 px-2.5 py-1 rounded-lg border border-slate-200">
                      ...
                      <select
                        ...
                        className="bg-transparent text-xs font-bold focus:outline-none cursor-pointer text-[#031246]"
                      >
                        {timerPresets.map((t) => (
                    ...
                    <button
                      ...
                      className="p-1.5 text-slate-400 hover:text-rose-500 disabled:opacity-30 disabled:hover:text-slate-400 transition-colors rounded-lg cursor-pointer"
                    >
            ...
            <button
              type="button"
              onClick={addQuestion}
              className="w-full py-4 border-2 border-dashed border-slate-300 hover:border-brand-purple rounded-3xl text-xs font-bold uppercase tracking-wider text-slate-600 hover:text-brand-purple flex items-center justify-center gap-2 transition-all cursor-pointer bg-white"
            >
          ...
          <div className="flex items-center justify-end gap-3 pt-6 border-t border-slate-200">
            <Link
              href="/organizer/dashboard"
              className="px-6 py-3 rounded-xl border border-slate-200 text-xs font-bold text-slate-600 hover:bg-slate-100 transition-colors"
            >
              Cancel
            </Link>
          ...
          <div className="w-full max-w-md p-6 rounded-3xl bg-white border border-slate-200 shadow-2xl space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-semibold focus:bg-white focus:outline-none focus:border-brand-purple"
              />
            </div>
          ...
          <div className="w-full max-w-md p-6 rounded-3xl bg-white border border-slate-200 shadow-2xl space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold text-brand-navy">Import from PDF</h3>
              </div>
              <button
                onClick={() => {
                  setShowPdfModal(false);
